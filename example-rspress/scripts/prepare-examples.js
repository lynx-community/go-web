/**
 * Copies @lynx-example/* packages from node_modules into
 * docs/public/lynx-examples/ with generated example-metadata.json files.
 *
 * Reuses the same logic as example/scripts/prepare-examples.js.
 */
...
console.log(`Prepared ${examples.length} examples in docs/public/lynx-examples/`);
